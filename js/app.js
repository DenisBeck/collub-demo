 ...
 */
    ...
    (() => {
        ...
        function showMore() {
            window.addEventListener("load", (function(e) {
                ...
                function showMoreActions(e) {
                    ...
                    if (targetType === "click") if (targetEvent.closest("[data-showmore-button]")) {
        ...
        const inputMask = document.querySelector(".input_phone");
        if (inputMask) {
        ...
        function pageNavigation() {
            ...
            function pageNavigationAction(e) {
                if (e.type === "click") {
                    if (bodyLockStatus) document.documentElement.classList.contains("menu-open") ? menuClose() : null;
